...
$videos = @(
    ...
    "https://media.americasimoveis.com.br/Criativos/Criativo%2028%20-%20Ary%20Rongel%20370%20UND%20203%20-%20590%20mil%20-AP0760_MERI_h265.mp4"
    ...
    #"https://media.americasimoveis.com.br/Criativos/Criativo%2031%20-%20Ocean%20BL%201%20UND%20507%202%20Qts%20-%20490%20mil%20-%20AP0097_MERI_h265.mp4"
...
foreach ($url in $videos) {
    ...
    ffmpeg -y -ss 9 -i "$url" -frames:v 1 -vf "scale=360:640" -c:v libwebp -quality 75 "$saida"
